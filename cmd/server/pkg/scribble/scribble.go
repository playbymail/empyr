...
// Package scribble implements a tiny JSON datastore.
// Copied from https://github.com/sdomino/scribble.
package scribble
...
// Options uses for specification of working scribble
type Options struct {
...
func New(dir string, options *Options) (*Driver, error) {
	...
	if opts.Logger != nil {
		opts.Logger.Printf("Creating scribble database at '%s'...\n", dir)
	}
...
func write(dir, tmpPath, dstPath string, v interface{}) error {
	log.Printf("[scribble] write(%q, %q, %q, v)\n", dir, tmpPath, dstPath)
