...
func (s *Store) GetEmpireGameSummary(empireID, asOfDate int64) (domains.UserGameSummary, error) {
	// get all games
	row, err := s.Queries.ReadEmpireByID(s.Context, sqlite.ReadEmpireByIDParams{
		EmpireID: empireID,
		AsOfDt:   asOfDate,
	})
	if err != nil {
